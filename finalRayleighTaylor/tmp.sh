...
#SBATCH --cpus-per-task=17 # ! This should be the maximum number of CPUs you wish to use per single MPI rank !
...
do
    for traversal_iter in hgridFit_hgc08 hgrid_block4 lc_c08 hgrid_block8
    do
